    ...
    schemas: {
      ...
      LineItem: {
        ...
        properties: {
          ...
          tax_category: { type: 'string', enum: ['S', 'Z', 'E', 'AE'], description: 'EN-16931-USt-Kategorie: S=Standard, Z=Nullsatz, E=steuerfrei (§4 UStG), AE=Reverse Charge (§13b). Ohne Angabe abgeleitet aus vat_rate (0→Z, sonst S).' },
          exemption_reason: { type: 'string', nullable: true, description: 'Grund der Steuerbefreiung (BT-120). Pflicht bei tax_category E oder AE.' },
      ...
      Draft: {
        ...
        properties: {
          ...
          service_date: { type: 'string', format: 'date', description: 'Leistungs-/Lieferdatum (§14 UStG, BT-72); Standard = Rechnungsdatum' },
          ...
          line_items: {
            ...
            items: {
              ...
              properties: {
                ...
                tax_category: { type: 'string', enum: ['S', 'Z', 'E', 'AE'], description: 'EN-16931-USt-Kategorie. Ohne Angabe abgeleitet aus vat_rate (0→Z, sonst S). Für E (§4 UStG) / AE (§13b) vat_rate=0 setzen und exemption_reason angeben.' },
                exemption_reason: { type: 'string', description: 'Grund der Steuerbefreiung (BT-120). Pflicht bei tax_category E oder AE.' },
              },
            },
          },
          invoice_date: { type: 'string', format: 'date' },
